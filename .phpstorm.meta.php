...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Domains\Admin\Plants\Contracts\PlantRepositoryInterface' => \App\Infrastructure\Repositories\EloquentPlantRepository::class,
    ...
    override(\config(), map([
            ...
            'event-sourcing.auto_discover_projectors_and_reactors' => 'array',
            'event-sourcing.auto_discover_base_path' => 'string',
            'event-sourcing.projectors' => 'array',
            'event-sourcing.reactors' => 'array',
            'event-sourcing.queue' => 'NULL',
            'event-sourcing.catch_exceptions' => 'boolean',
            'event-sourcing.stored_event_model' => 'string',
            'event-sourcing.stored_event_repository' => 'string',
            'event-sourcing.snapshot_repository' => 'string',
            'event-sourcing.snapshot_model' => 'string',
            'event-sourcing.stored_event_job' => 'string',
            'event-sourcing.enforce_event_class_map' => 'boolean',
            'event-sourcing.event_class_map' => 'array',
            'event-sourcing.event_serializer' => 'string',
            'event-sourcing.event_normalizers' => 'array',
            'event-sourcing.cache_path' => 'string',
            'event-sourcing.dispatch_events_from_aggregate_roots' => 'boolean',
            ...
            'filesystems.links./Users/chrisganzert/PhpstormProjects/Planting/public/storage' => 'string',
...
'database.redis.cache.database','event-sourcing.auto_discover_projectors_and_reactors','event-sourcing.auto_discover_base_path','event-sourcing.projectors','event-sourcing.reactors',
'event-sourcing.queue','event-sourcing.catch_exceptions','event-sourcing.stored_event_model','event-sourcing.stored_event_repository','event-sourcing.snapshot_repository',
'event-sourcing.snapshot_model','event-sourcing.stored_event_job','event-sourcing.enforce_event_class_map','event-sourcing.event_class_map','event-sourcing.event_serializer',
'event-sourcing.event_normalizers','event-sourcing.cache_path','event-sourcing.dispatch_events_from_aggregate_roots','filesystems.default','filesystems.disks.local.driver',
...
'filesystems.links./Users/chrisganzert/PhpstormProjects/Planting/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'debugbar.debug_backtrace_limit','boost.browser_logs_watcher','livewire.class_namespace','livewire.view_path','livewire.layout',
...
'debugbar.queries.explain','boost.browser-logs','generated::7gm5GIojkLVCIZiv','generated::Zp787KdUsIHbVvBT','generated::e5CicgNW8CcgkpUN',
'generated::RDsxnBeraOXBhzwR','generated::6cKGBdzmfJoEbATm','livewire.update','generated::muHze2zaEReKh6zj','generated::1L3aVJhryKrPWJCI',
'livewire.upload-file','livewire.preview-file','generated::lOXMmw9Z0Qs8PpRq','home','dashboard',
'generated::X2YfX8lbeMopQtzS','settings.profile','settings.password','settings.appearance','generated::fVgkjrTGcixas5sM',
'plants.dashboard','plants.index','plants.create','plants.show','plants.edit',
...
'components.card','components.layouts.app','components.layouts.app.header','components.layouts.app.sidebar','components.layouts.auth',
'components.layouts.auth.card','components.layouts.auth.simple','components.layouts.auth.split','components.placeholder-pattern','components.plants.buttons.back',
'components.plants.buttons.contribute','components.plants.buttons.create','components.plants.buttons.delete','components.plants.buttons.edit','components.plants.buttons.restore',
'components.plants.cards.plant-show-card','components.plants.components.badges','components.plants.components.metadata','components.plants.components.section','components.plants.layout',
'components.plants.layout.create','components.plants.layout.crud','components.plants.layout.dashboard','components.plants.layout.index','components.plants.layout.show',
...
'livewire.auth.register','livewire.auth.reset-password','livewire.auth.verify-email','livewire.plant.create','livewire.plant.dashboard',
'livewire.plant.edit','livewire.plant.index','livewire.plant.show','livewire.settings.appearance','livewire.settings.delete-user-form',
'livewire.settings.password','livewire.settings.profile','partials.head','partials.plants.heading','partials.plants.show.actions',
'partials.plants.show.details','partials.plants.show.heading','partials.plants.show.metadata','partials.settings-heading','volt-livewire::auth.confirm-password',
...
'volt-livewire::plant.create','volt-livewire::plant.dashboard','volt-livewire::plant.edit','volt-livewire::plant.index','volt-livewire::plant.show',
'volt-livewire::settings.appearance','volt-livewire::settings.delete-user-form','volt-livewire::settings.password','volt-livewire::settings.profile','welcome',
